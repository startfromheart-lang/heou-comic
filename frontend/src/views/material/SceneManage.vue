  ...
  <div>
    ...
    <div class="card-container">
      <div class="search-bar">
        <el-input v-model="searchForm.sceneName" placeholder="场景名称" clearable style="width: 200px;" />
      ...
      <el-table :data="tableData" style="width: 100%" v-loading="loading">
        ...
        <el-table-column prop="positioning" label="场景定位" />
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="600px">
      <el-form :model="form" :rules="rules" ref="formRef" label-width="80px">
        ...
        <el-form-item label="场景定位" prop="positioning">
          <el-input v-model="form.positioning" placeholder="如：都市传说、星际冒险等" />
        </el-form-item>
...
import { getSceneList, createScene, updateScene, deleteScene } from '@/api'
